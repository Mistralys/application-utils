...
class XMLHelper_LibXML
{
    ...
    const NO_MEMORY = 2;
    const DOCUMENT_START = 3;
    const DOCUMENT_EMPTY = 4;
    const DOCUMENT_END = 5;
    const INVALID_HEX_CHARREF = 6;
    const INVALID_DEC_CHARREF = 7;
    const INVALID_CHARREF = 8;
    const INVALID_CHAR = 9;
    const CHARREF_AT_EOF = 10;
    const CHARREF_IN_PROLOG = 11;
    const CHARREF_IN_EPILOG = 12;
    const CHARREF_IN_DTD = 13;
    const ENTITYREF_AT_EOF = 14;
    const ENTITYREF_IN_PROLOG = 15;
    const ENTITYREF_IN_EPILOG = 16;
    const ENTITYREF_IN_DTD = 17;
    const PEREF_AT_EOF = 18;
    const PEREF_IN_PROLOG = 19;
    const PEREF_IN_EPILOG = 20;
    const PEREF_IN_INT_SUBSET = 21;
    const ENTITYREF_NO_NAME = 22;
    const ENTITYREF_SEMICOL_MISSING = 23;
    const PEREF_NO_NAME = 24;
    const PEREF_SEMICOL_MISSING = 25;
    const UNDECLARED_ENTITY = 26;
    const XML_WAR_UNDECLARED_ENTITY = 27;
    const UNPARSED_ENTITY = 28;
    const ENTITY_IS_EXTERNAL = 29;
    const ENTITY_IS_PARAMETER = 30;
    const UNKNOWN_ENCODING = 31;
    const UNSUPPORTED_ENCODING = 32;
    const STRING_NOT_STARTED = 33;
    const STRING_NOT_CLOSED = 34;
    const NS_DECL_ERROR = 35;
    const ENTITY_NOT_STARTED = 36;
    const ENTITY_NOT_FINISHED = 37;
    const LT_IN_ATTRIBUTE = 38;
    const ATTRIBUTE_NOT_STARTED = 39;
    const ATTRIBUTE_NOT_FINISHED = 40;
    const ATTRIBUTE_WITHOUT_VALUE = 41;
    const ATTRIBUTE_REDEFINED = 42;
    const LITERAL_NOT_STARTED = 43;
    const LITERAL_NOT_FINISHED = 44;
    const COMMENT_NOT_FINISHED = 45;
    const PI_NOT_STARTED = 46;
    const PI_NOT_FINISHED = 47;
    const NOTATION_NOT_STARTED = 48;
    const NOTATION_NOT_FINISHED = 49;
    const ATTLIST_NOT_STARTED = 50;
    const ATTLIST_NOT_FINISHED = 51;
    const MIXED_NOT_STARTED = 52;
    const MIXED_NOT_FINISHED = 53;
    const ELEMCONTENT_NOT_STARTED = 54;
    const ELEMCONTENT_NOT_FINISHED = 55;
    const XMLDECL_NOT_STARTED = 56;
    const XMLDECL_NOT_FINISHED = 57;
    const CONDSEC_NOT_STARTED = 58;
    const CONDSEC_NOT_FINISHED = 59;
    const EXT_SUBSET_NOT_FINISHED = 60;
    const DOCTYPE_NOT_FINISHED = 61;
    const MISPLACED_CDATA_END = 62;
    const CDATA_NOT_FINISHED = 63;
    const RESERVED_XML_NAME = 64;
    const SPACE_REQUIRED = 65;
    const SEPARATOR_REQUIRED = 66;
    const NMTOKEN_REQUIRED = 67;
    const NAME_REQUIRED = 68;
    const PCDATA_REQUIRED = 69;
    const URI_REQUIRED = 70;
    const PUBID_REQUIRED = 71;
    const LT_REQUIRED = 72;
    const GT_REQUIRED = 73;
    const LTSLASH_REQUIRED = 74;
    const EQUAL_REQUIRED = 75;
    const TAG_NAME_MISMATCH = 76;
    const TAG_NOT_FINISHED = 77;
    const STANDALONE_VALUE = 78;
    const ENCODING_NAME = 79;
    const HYPHEN_IN_COMMENT = 80;
    const INVALID_ENCODING = 81;
    const EXT_ENTITY_STANDALONE = 82;
    const CONDSEC_INVALID = 83;
    const VALUE_REQUIRED = 84;
    const NOT_WELL_BALANCED = 85;
    const EXTRA_CONTENT = 86;
    const ENTITY_CHAR_ERROR = 87;
    const ENTITY_PE_INTERNAL = 88;
    const ENTITY_LOOP = 89;
    const ENTITY_BOUNDARY = 90;
    const INVALID_URI = 91;
    const URI_FRAGMENT = 92;
    const XML_WAR_CATALOG_PI = 93;
    const NO_DTD = 94;
    const CONDSEC_INVALID_KEYWORD = 95;
    const VERSION_MISSING = 96;
    const XML_WAR_UNKNOWN_VERSION = 97;
    const XML_WAR_LANG_VALUE = 98;
    const XML_WAR_NS_URI = 99;
    const XML_WAR_NS_URI_RELATIVE = 100;
    const MISSING_ENCODING = 101;
    const XML_WAR_SPACE_VALUE = 102;
    const NOT_STANDALONE = 103;
    const ENTITY_PROCESSING = 104;
    const NOTATION_PROCESSING = 105;
    const XML_WAR_NS_COLUMN = 106;
    const XML_WAR_ENTITY_REDEFINED = 107;
    const UNKNOWN_VERSION = 108;
    const VERSION_MISMATCH = 109;
    const NAME_TOO_LONG = 110;
    const USER_STOP = 111;
